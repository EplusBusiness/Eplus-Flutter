...
mixin _$CreateFormState {
  ...
  List<AttachmentInfo> get listCmnd => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      listItems: null == listItems
          ...
          : listItems // ignore: cast_nullable_to_non_nullable
              as List<ItemInfo>,
      listCmnd: null == listCmnd
          ? _value.listCmnd
          : listCmnd // ignore: cast_nullable_to_non_nullable
...
class _$_CreateFormState implements _CreateFormState {
  const _$_CreateFormState(
      ...
      final List<AttachmentInfo> listCmnd = const <AttachmentInfo>[
        AttachmentInfo(),
        AttachmentInfo()
      ]})
  ...
  final List<AttachmentInfo> _listCmnd;
  @override
  @JsonKey()
  List<AttachmentInfo> get listCmnd {
    if (_listCmnd is EqualUnmodifiableListView) return _listCmnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_listCmnd);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._listCmnd, _listCmnd));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_listCmnd));
...
abstract class _CreateFormState implements CreateFormState {
  const factory _CreateFormState(
      ...
      final List<AttachmentInfo> listCmnd}) = _$_CreateFormState;
...
mixin _$ProductInfo {
  ...
  int? get indexOptionSelected => throw _privateConstructorUsedError;
  String? get noteWithOptions => throw _privateConstructorUsedError;
...
class _$ProductInfoCopyWithImpl<$Res, $Val extends ProductInfo>
  ...
  $Res call({
    ...
    Object? indexOptionSelected = freezed,
    Object? noteWithOptions = freezed,
  }) {
    return _then(_value.copyWith(
      stock: freezed == stock
          ? _value.stock
      ...
      itemInfo: freezed == itemInfo
          ...
          : itemInfo // ignore: cast_nullable_to_non_nullable
              as ItemInfo?,
      indexOptionSelected: freezed == indexOptionSelected
          ? _value.indexOptionSelected
          : indexOptionSelected // ignore: cast_nullable_to_non_nullable
              as int?,
      noteWithOptions: freezed == noteWithOptions
          ? _value.noteWithOptions
          : noteWithOptions // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
...
class _$_ProductInfo implements _ProductInfo {
  const _$_ProductInfo(
      ...
      this.note,
      this.itemInfo,
      this.indexOptionSelected,
      this.noteWithOptions});
  ...
  @override
  final int? indexOptionSelected;
  @override
  final String? noteWithOptions;

  @override
  String toString() {
    return 'ProductInfo(stock: $stock, note: $note, itemInfo: $itemInfo, indexOptionSelected: $indexOptionSelected, noteWithOptions: $noteWithOptions)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.indexOptionSelected, indexOptionSelected) ||
                other.indexOptionSelected == indexOptionSelected) &&
            (identical(other.noteWithOptions, noteWithOptions) ||
                other.noteWithOptions == noteWithOptions));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, stock, note, itemInfo, indexOptionSelected, noteWithOptions);
...
abstract class _ProductInfo implements ProductInfo {
  const factory _ProductInfo(
      ...
      final ItemInfo? itemInfo,
      final int? indexOptionSelected,
      final String? noteWithOptions}) = _$_ProductInfo;
  ...
  @override
  int? get indexOptionSelected;
  @override
  String? get noteWithOptions;
  @override
  @JsonKey(ignore: true)
  _$$_ProductInfoCopyWith<_$_ProductInfo> get copyWith =>
      throw _privateConstructorUsedError;
